...
# ラボ: Service Trust Portal を詳細に確認する
...
#### タスク 1: このタスクでは、Service Trust Portal と利用可能なさまざまな種類のコンテンツを詳細に確認あしべ、レポートにアクセスする方法と、レポートをライブラリに保存する方法を学習します。 
...
#### タスク 2: このタスクでは、セキュリティ センターにアクセスして、Microsoft の 6 つの主要なプライバシー原則に移動します。
